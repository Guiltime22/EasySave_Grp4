...
namespace test
{
    class Program
    {
        ...
        public class Butter
        {
            ...
            static public Sauvegarde_Sequentielle SVS = new Sauvegarde_Sequentielle(); // Instance to use class Sauvegarde Sequentielle
        ...
        static void Main(string[] args) // the main function
        {
            ...
            while (true)
            {
                ...
                Travail SV = new Travail(); //Instance to use class sauvegarde
                Gestion_Travail GTV = new Gestion_Travail(); // Instance to use class Sauvegarde Sequentielle
                ...
                {
                    Console.Clear();
                    GTV.Gestion_Travail_Sauvegarde(nbFichiersSD); //function of gestion
                }
